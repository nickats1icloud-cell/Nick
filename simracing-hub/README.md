...
Ανέβασε **όλο τον φάκελο** `simracing-hub/` (ή το περιεχόμενό του στο
...
- **Χρώματα:** πάντα μέσω CSS custom properties σε μορφή HSL components, ώστε
  να δουλεύει το `hsl(var(--ember) / 0.4)`.
...
Σκόπιμα **διαφορετική** από το αρχικό:

| | Αρχικό | Εδώ |
|---|---|---|
| Βάση | βαθύ navy `hsl(210 40% 6%)` | ουδέτερο γραφίτης `hsl(220 8% 7%)` |
| Κύριο χρώμα | μπλε Ελλάδας `#1565C0` | ember πορτοκαλί `#FF6B2C` |
| Δεύτερο | ανοιχτό μπλε | παγωμένο τιρκουάζ `#25D8C4` |
