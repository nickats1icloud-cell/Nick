...
function draw() {
  ...
  if (state.mode === "login") {
    ...
    form.innerHTML = `${field("Email", "email", "email", "Το email σου", 'required autocomplete="email"')}
      ...
      <p style="text-align:right"><button type="button" class="u-small" style="background:none;border:0;color:hsl(var(--ember));cursor:pointer" data-go="forgot">Ξέχασες τον κωδικό;</button></p>
    ...
    switchNode.innerHTML = registrationOff
      ...
      : 'Δεν έχεις λογαριασμό; <button type="button" style="background:none;border:0;color:hsl(var(--ember));cursor:pointer;font-weight:500" data-go="signup">Εγγραφή</button>';
    return;
  }
  ...
  switchNode.innerHTML =
    'Έχεις ήδη λογαριασμό; <button type="button" style="background:none;border:0;color:hsl(var(--ember));cursor:pointer;font-weight:500" data-go="login">Σύνδεση</button>';
}
