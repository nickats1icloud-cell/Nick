            ...
            ? messages
                .map((message) => {
                  ...
                  return `<div class="chat__msg ${mine ? "chat__msg--mine" : ""} ${message.is_admin ? "chat__msg--staff" : ""}">
                    ${mine ? "" : `<p class="u-tiny u-faint u-row" style="gap:6px;margin-bottom:4px">${avatar(sender, "xs")}${esc(nameOf(sender))}${message.is_admin ? ' <span class="hub-badge hub-badge--accent">Staff</span>' : ""}</p>`}
